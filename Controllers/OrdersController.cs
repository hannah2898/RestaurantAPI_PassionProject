...
using RestaurantAPI_PassionProject.Controllers;
using RestaurantAPI_PassionProject.Migrations;
...
namespace RestaurantWebApp.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public ActionResult MenuItemsForOrder(int orderId)
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                IEnumerable<MenuDto> menuItems = response.Content.ReadAsAsync<IEnumerable<MenuDto>>().Result;
